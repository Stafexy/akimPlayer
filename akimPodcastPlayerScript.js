...
<div class="controls-container myFlex">
	<div class="playPauseBtn akimBtn circle akimHover">
		<svg class="playBtn cBtn" viewBox="-4 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M50 30L10 55V5L50 30Z"/></svg>
...
<div class="volume-container myFlex">
	<div class="volumeBtn akimBtn circle">
		<svg class="vol1 cBtn" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M27.7778 19.2857H10V40.7143H27.7778L50 55V5L27.7778 19.2857Z"/></svg>
		<svg class="vol0 cBtn" style="display:none" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg"><path class="vol0ff" d="M27.7778 19.2857H10V40.7143H27.7778L50 55V5L27.7778 19.2857Z"/><path class="volOff" d="M15 5L50 55" stroke-width="5"/><path class="volOff" d="M50 5L15 55" stroke-width="5"/></svg></div>
